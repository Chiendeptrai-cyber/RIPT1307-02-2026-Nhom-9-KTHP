...
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Laptop Dell XPS 13' LIMIT 1), 1),
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Webcam Logitech C920' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Máy chiếu Epson EB-S41' LIMIT 1), 1),
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Màn chiếu 100 inch' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='USB Hub 7 cổng Anker' LIMIT 1), 2),
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Cáp HDMI 2.1 2m' LIMIT 1), 3);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Laptop HP EliteBook 840' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Oscilloscope Rigol DS1054Z' LIMIT 1), 1),
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Đồng hồ vạn năng Fluke 87V' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Raspberry Pi 4 Model B' LIMIT 1), 2);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Laptop Lenovo ThinkPad X1' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Headphone Sony WH-1000XM5' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Máy chiếu BenQ MH560' LIMIT 1), 1),
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Con trỏ laser Logitech R500' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Bộ nguồn DC thí nghiệm' LIMIT 1), 2),
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Đồng hồ vạn năng Fluke 87V' LIMIT 1), 2);
...
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Webcam Logitech C920' LIMIT 1), 1),
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Micro cài áo Sony ECM-CS3' LIMIT 1), 2),
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Loa Bluetooth JBL Flip 5' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='Laptop Dell XPS 13' LIMIT 1), 5);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='MacBook Pro M2 14"' LIMIT 1), 1);
...
INSERT INTO borrow_request_items (borrow_request_id, equipment_id, quantity)
VALUES
  (currval('borrow_requests_id_seq'), (SELECT id FROM equipment WHERE name='USB-C Docking Station' LIMIT 1), 1);
